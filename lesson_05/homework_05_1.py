...
car_data_filtered: dict = {car: (colour, year, engine_volume, body_type, price) for car, (colour, year, engine_volume, body_type, price) in car_data.items() if year >= search_criteria[0] and engine_volume >= search_criteria[1] and price <= search_criteria[2]}
